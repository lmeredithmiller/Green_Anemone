...
**Figure 3**: Size data, using gamlss with Log Normal distribution. Significance compared to pre-heat of control.
...
**Figure 4**: Feeding data, using gamlss with Log Normal distribution. Significance compared to pre-heat of control.
