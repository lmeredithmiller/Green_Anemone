...
Green_Weibull_model <- gamlss(formula = Green_Density ~ Time_Point*Treatment + random(Species_ID) +random(Field_Site), family = WEI(), data = Green_Symbionts, control = gamlss.control(n.cyc = 8))
summary(Green_Weibull_model)

#Dino
Dino_Symbionts$orderTreatment = ordered(Dino_Symbionts$Treatment, levels = c("Control", "25C", "30C"))

Dino_Gamma_model <- gamlss(formula = Dino_Density ~ Time_Point*Treatment + random(Species_ID) + random(Field_Site), family = GA(), data = Dino_Symbionts, control = gamlss.control(n.cyc = 3))
...
Treatment30C             1.814192   0.330629   5.487 1.43e-05 ***
