...
Green_Gamma <- histDist(Green_Density_data$Green_Density, "GA", density = F, main = "Gamma")
...
Dino_Weibull <- histDist(Dino_Density_data$Dino_Density, "WEI", density = F, main = "Weibull")
```
