...
bartlett.test(Base_Diameter_mm ~ Treatment, data = filtered_dates) # p-value = 0.15, yay equal variance
```
...
bartlett.test(Feeding_Time_Min ~ Treatment, data = Feeding_Data) # p-value < 0.05, no equal varaince 
```
