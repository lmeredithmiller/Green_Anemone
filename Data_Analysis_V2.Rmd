...
```{r, warning=FALSE, message=FALSE}
exp_test(filtered_PAM_data$PAM_avg)        #p-value < 2.2e-16, cannot use
gamma_test(filtered_PAM_data$PAM_avg)      #p-value < 2.2e-16, cannot use
lnorm_test(filtered_PAM_data$PAM_avg)      #p-value < 2.2e-16, cannot use
normal_test(filtered_PAM_data$PAM_avg)     #p-value = 1.706e-06, cannot use
weibull_test(filtered_PAM_data$PAM_avg)    #p-value < 2.2e-16, cannot use
```
